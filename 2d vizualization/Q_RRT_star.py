...
# Function for running the Quick RRT* algorithm
def Quick_RRT_star(start, goal, iterations=2000, search_radius=20, ad=1, step_size=10):
    ...
    # Iterating over the number of iterations for Quick RRT*
    for u in range(iterations):
        if iterations % 10 == 0:
            out.write(canvas)
        # Randomly selecting a point by checking if the random point is greater than 5
...
# Initializing the time, costs, and depths
times = []
costs = []
depths = []
...
# Running the Quick RRT* algorithm
